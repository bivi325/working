...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    value: function create() {
      this.scene.start(_CST.CST.SCENES.MENU, "menu start");
    }
  }]);
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    key: "create",
    value: function create() {
      this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.2, "title").setDepth(1);
      this.add.image(0, 0, "background").setOrigin(0).setDepth(0);
      var hoverCat = this.add.sprite(100, 100, "cat");
      hoverCat.setScale(2);
      this.anims.create({
        key: 'walk',
        frameRate: 4,
      ...
      var playButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.4, "play").setDepth(1);
      var refuseButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.5, "refuse").setDepth(1);
      var moreButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.6, "more").setDepth(1);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13431" + '/');
